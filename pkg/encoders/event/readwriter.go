...
// MarshalWrite writes the JSON representation of an event to an io.Writer.
// This is a version of MarshalWithWhitespace that writes to an io.Writer
// instead of appending to a slice, with whitespace disabled by default.
// It implements the codec.I interface.
func (ev *E) MarshalWrite(w io.Writer) (err error) {
	return ev.MarshalWriteWithWhitespace(w, false)
}

// MarshalWriteWithWhitespace writes the JSON representation of an event to an io.Writer
// with optional whitespace formatting. If the 'on' flag is set to true, it adds tabs 
// and newlines to make the JSON more readable for humans. This is a version of 
// MarshalWithWhitespace that writes to an io.Writer instead of appending to a slice.
