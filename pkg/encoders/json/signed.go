...
//
// Technically we are supporting negative numbers here but in fact in nostr
// message encodings there is no such thing as any negative integers, nor
// floating point, but this ensures if there is ever need for negative values
// they are supported. For the most part this will be used for timestamps.
//
// There is a NewSigned function that accepts any type of generic signed integer
// value and automatically converts it to the biggest type that is used in
// runtime.
