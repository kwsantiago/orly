...
//
// There is a generic NewUnsigned function which will automatically convert any
// integer type to the internal uint64 type, saving the caller from needing to
// cast it in their code.
