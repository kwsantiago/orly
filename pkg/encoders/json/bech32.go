...
// Bech32 is a string encoded in bech32 format including a human-readable prefix
// and base32 encoded binary data. A key difference is the HRP prefix.
//
// To create a new Bech32, load the HRP variable with the intended HRP for
// encoding.
//
// When decoding, point this variable at the expected HRP, if it doesn't match
// in what is encoded, it returns an error.
