...
type I interface {
	...
	// AcceptEvent(c context.T, ev *event.E, hr *http.Request, origin string,
...
// // WebSocketHandler is passed nostr message types unrecognized by the server. The
// // server handles "EVENT", "REQ" and "CLOSE" messages, as described in NIP-01.
